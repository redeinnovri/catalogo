...
document.addEventListener('DOMContentLoaded', () => {
	...
	// Fetch JSON data
	fetch('https://ruifgcosta.github.io/ecommerceapi/arcondicionado.json')
	...
	function updateFilterStates(filteredProducts) {
		const filterContainers = [
			...
			{ container: filterViscosidade, prop: 'Gas' },
					...
					product.NomeComercial
                            ...
                            <ul class="list-group p-10">
                                <li class="list-group-item d-flex align-items-start flex-wrap">
                                    <div class="ms-2 me-auto">Gás</div>
                                    <span class="badge bg-light text-dark p-2" style="font-weight: 700">${product.Gas || 'N/D'}</span>
                                </li>
                                <li class="list-group-item d-flex align-items-start flex-wrap">
                                    <div class="ms-2 me-auto">Funcionamento</div>
                                    <span class="badge bg-light text-dark p-2" style="font-weight: 700">${product.Funcionamento || 'N/D'}</span>
                                </li>
                            </ul>
                        </div>
                    </div>`;
